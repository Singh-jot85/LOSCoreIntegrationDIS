...
interfaces = {
    ...
    "ci-csi-create_customer":{
        "validation_spec": "{}",
        "request_body_spec": ".loan_relations[] | (if (.relation_type == \"borrower\" or .relation_type == \"guarantor\") then \n    {\n        tin: ((.tin) // null),\n        tinid: (($tinid[.tin_type]) // null),\n        lastName: ((if .party_type == \"individual\" and .last_name != null then .last_name | ascii_upcase else null end) // null),\n        firstName: ((if .party_type == \"individual\" and .first_name != null then .first_name | ascii_upcase else null end) // null),\n        customerType: ((if.entity_type != null then $customerType[.entity_type] else \"I\" end) // null),\n        address1: ((.relation_addresses[] | select(.address_type == \"permanent\") | (.address_line_1 + \" \" +.address_line_2 ) | ascii_upcase) // null),\n        address2: ((.relation_addresses[] | select(.address_type == \"permanent\") | (if.zip_code_plus4 != null then (.city + \" \" + .state + \" \" + .zip_code + \"-\" + .zip_code_plus4) | ascii_upcase else (.city + \" \" + .state + \" \" + .zip_code) | ascii_upcase end)) // null),\n        emailAddress: ((if .email != null then .email | ascii_upcase else null end) // null),\n        primaryPhone: ((if .work_phone != null then .work_phone|tostring elif .cell_phone != null then .cell_phone|tostring else .home_phone|tostring end) // null),\n        phone1: ((if .work_phone != null then .work_phone|tostring elif .cell_phone != null then .cell_phone|tostring else .home_phone|tostring end) // null),\n        phone1Code: null,\n        idType: ((if .party_type == \"individual\" and (.identification_infos | length > 0) then (.identification_infos[] | select(.category == \"primary\") | $idType[.id_type]) else null end) // null),\n        idLocation: ((if .party_type == \"individual\" and (.identification_infos | length > 0) then (.identification_infos[] | select(.category == \"primary\") | .issued_by_state) else null end) // null),\n        idIssueDate: ((if .party_type == \"individual\" and (.identification_infos | length > 0) then (.identification_infos[] | select(.category == \"primary\") | .issued_date) else null end) // null),\n        branchCode: ((if .branch_code | length == 2 then \"00\"+.branch_code elif .branch_code | length == 3 then \"0\"+.branch_code else null end) // null),\n        naicsCode: ((.naics_code | tostring) // null),\n        middleName: ((if .party_type == \"individual\" and .middle_name != null then .middle_name | ascii_upcase else null end) // null),\n        businessName: ((if .party_type == \"entity\" and .business_name != null then .business_name | ascii_upcase else null end) // null),\n        address3: null,\n        firstContactDate: null,\n        gender: null,\n        spouse: null,\n        bankInfoComment: null,\n        bankEmployeeFlag: null,\n        deleteOverride: $deleteOverride,\n        officer: ((if .loan_officer_name != null then($officer[.loan_officer_name]) else null end) // null),\n        maritalStatus: null,\n        pin: null,\n        profitStmtFreq: null,\n        profitStmtModel: null,\n        dateofBirth: ((if .dob != null then .dob else null end) // null),\n        privacyNoticeDate: null,\n        privacyOptOut: null,\n        householdKey: null,\n        houseHoldKeyCode: null,\n        cipStatus: null,\n        cipDate: null,\n        foreignAddressIndicator: null,\n        naicsCode: ((.naics_code | tostring) // null),\n        bsaRisk: null,\n        phone2: null,\n        phone2Code: null,\n        phone3: null,\n        phone3Code: null,\n        phone4: null,\n        phone4Code: null,\n        education: null,\n        salutation: null,\n        occupation: null,\n        employer: null,\n        creditRating: null,\n        demographicComment: null,\n        residenceValue: null,\n        financedBy: null,\n        numDependents: null,\n        majorCreditor: null,\n        residenceDate: null,\n        dateLastFinancialStmt: null,\n        financialStatementOfficer: null,\n        financialStmtComment: null,\n        demographicsFree: null,\n        emailNoticeFlag: null,\n        idNumber: ((if .party_type == \"individual\" and (.identification_infos | length > 0) then (.identification_infos[] | select(.category == \"primary\") | .identifier) else null end) // null),\n        idExpirationDate: ((if .party_type == \"individual\" and (.identification_infos | length > 0) then (.identification_infos[] | select(.category == \"primary\") | .expiration_date) else null end) // null),\n        dateOfDeath: null,\n        excludeMarketing: null,\n        creditBureauAlertFlag: null,\n        customerAlertFlag: null,\n        creditBureauAlertDate: null,\n        customerAlertDate: null,\n        securityQuestion1: null,\n        securityAnswer1: null,\n        securityQuestion2: null,\n        securityAnswer2: null,\n        securityQuestion3: null,\n        securityAnswer3: null,\n        tinCertCode: null,\n        tinCertDate: null,\n        incomeCode: null,\n        internetBankingRestrict: null,\n        excludePrivacy: null,\n        idTheftProtectServiceFlag: null,\n        officer2: null,\n        officer3: null,\n        csr: null,\n        operatingStatus: null,\n        businessStartDate: ((if .business_established_date != null then .business_established_date else null end) // null),\n        businessActivity: null\n    }\n    else empty end)",
        "response_body_spec": "{\n    apiSuccess: (if has(\"apiSuccess\") then .apiSuccess else false end),\n    errors: ((if .apiSuccess == false and .errors then ({\"errorMsg\": (if .errors.errorMsg|type == \"string\" then .errors.errorMsg elif .errors.errorMsg | has(\"InnerException\") then .errors.errorMsg.InnerException.InnerException.Message else .errors.errorMsg.message end), \"errorNum\": (if .errors|has(\"errorNum\") then .errors.errorNum else \"\" end)}) else null end) // null),\n    responses: (if .apiSuccess then {customerid:.responses.customerGuid} else null end) \n}",
        "request_body_spec_config": "{\n    \"deleteOverride\":\"0\",\n    \"tinid\":{\n        \"SSN\":\"S\",\n        \"EIN\":\"E\"\n    },\n    \"customerType\":{\n        \"single_member_llc\":\"L\",\n        \"sole_proprietor\":\"S\",\n        \"partnership\":\"R\",\n        \"independent_contractor\":\"I\",\n        \"llc\":\"L\",\n        \"llp\":\"L\",\n        \"self_employed\":\"I\",\n        \"s_corp\":\"C\",\n        \"c_corp\":\"C\",\n        \"professional_association\":\"A\"\n    },\n    \"idType\":{\n        \"drivers_license\":\"6\",\n        \"us_passport\":\"7\",\n        \"us_green_card\":\"8\",\n        \"military_id\":\"43\",\n        \"state_federal_issued\":\"8\"\n    },\n    \"officer\":{\n       \"Daniel Salmon\":\"202\",\n       \"Kelly Mace Miller\":\"204\",\n       \"Brian D Miller\":\"205\",\n       \"Joe Powers\":\"206\",\n       \"Daniel J Salmon\":\"210\",\n       \"Brian D Miller\":\"211\",\n       \"Kelly K Miller\":\"213\",\n       \"DO NOT USE-WORKOUT\":\"250\",\n       \"Darrell L Jaggers\":\"300\",\n       \"DO NOT USE-UNCOLLECTABLE\":\"800\",\n       \"Aracely Ledezma\":\"A_L\",\n       \"Amy Varga\":\"AKV\",\n       \"Amy Kezy\":\"ALK\",\n       \"Andrea Moore\":\"AM\",\n       \"Andrew M Steffel\":\"AMS\",\n       \"Art Russell\":\"AR\",\n       \"Andrea Watson\":\"AW\",\n       \"Brad A Duncan\":\"BAD\",\n       \"Benjamin C Jefferis\":\"BCJ\",\n       \"Brian Ternet\":\"BCT\",\n       \"Brian Miller\":\"BDM\",\n       \"Bryan G Olund\":\"BGO\",\n       \"Barb Jerzyk\":\"BJ\",\n       \"Deposit Operations\":\"BKG\",\n       \"Branch Loan\":\"BL\",\n       \"Brittany Breen\":\"BNB\",\n       \"Chris Campbell\":\"CDC\",\n       \"Chris Cossell\":\"CEC\",\n       \"Clay G Koehler\":\"CGK\",\n       \"Christine Milton\":\"CIM\",\n       \"Christine Tanjic\":\"CIT\",\n       \"Cara l Jones\":\"CLJ\",\n       \"Cindy Orzechowicz\":\"CO\",\n       \"Doug A Wood\":\"DAG\",\n       \"Dan Beechy\":\"DB\",\n       \"David Bowers\":\"DCB\",\n       \"Dan C Hanson\":\"DCH\",\n       \"Dan Peter\":\"DGP\",\n       \"David Giedemann\":\"DJG\",\n       \"Dan Salmon\":\"DJS\",\n       \"David Schnepp\":\"DLS\",\n       \"Derek M Phillips\":\"DMP\",\n       \"Dana Snyder\":\"DNS\",\n       \"Dave R Miller\":\"DRM\",\n       \"David Taylor\":\"DT\",\n       \"Ed Schiesser\":\"EAS\",\n       \"Erik Dombrowski\":\"ED\",\n       \"Greg Gottschalk\":\"GDG\",\n       \"Greg Widelski\":\"GFW\",\n       \"Greg Gordon\":\"GG\",\n       \"Gina M Storm\":\"GMS\",\n       \"Gabe W Cripe\":\"GWC\",\n       \"Jeff A Marsee\":\"JAM\",\n       \"Jonathan A. Walker\":\"JAW\",\n       \"Juli Beilicek\":\"JB\",\n       \"Jonathan Hildebrandt\":\"JBH\",\n       \"J Blake Sanderson\":\"JBS\",\n       \"John Misiora\":\"JCM\",\n       \"Joshua D Stuckey\":\"JDS\",\n       \"John D Wingfield\":\"JDW\",\n       \"Jeff F Olds\":\"JFO\",\n       \"John Rybicki\":\"JJR\",\n       \"Jason L Taege\":\"JLT\",\n       \"Jennifer Willis\":\"JLW\",\n       \"Jean Hershberger\":\"JMH\",\n       \"Julie N Birmingham\":\"JNB\",\n       \"Jamie Orcutt\":\"JO\",\n       \"Joe Powers\":\"JP\",\n       \"Jesse Dame\":\"JVD\",\n       \"Jami Weinrich\":\"JW\",\n       \"Kaylin A Korbelik\":\"KAK\",\n       \"Kelly Miller\":\"KKM\",\n       \"Kathy Sears\":\"KLS\",\n       \"Kevin Cahill\":\"KMC\",\n       \"Katie M Westlund\":\"KMW\",\n       \"Kevin S Broadstreet\":\"KSB\",\n       \"Katie Westlund Ponton\":\"KWP\",\n       \"Lydia Bowen\":\"L_B\",\n       \"Leonardo A Amat\":\"LAA\",\n       \"Lisa Pensinger\":\"LMP\",\n       \"Lydia Post\":\"LP\",\n       \"Lupita Pacheco Lopez\":\"LPL\",\n       \"Mary Dowd\":\"MCD\",\n       \"Michael Schrage\":\"MES\",\n       \"Michael Hardtke\":\"MH1\",\n       \"Mende Jofceski\":\"MJ\",\n       \"Mary Jo Kennelly\":\"MJK\",\n       \"Mary Panas\":\"MKP\",\n       \"Mark Baird\":\"MLB\",\n       \"Mark Stevenson\":\"MSS\",\n       \"Meredith Thompson\":\"MT\",\n       \"Matt Stoops\":\"MVS\",\n       \"Nick Matthews\":\"NRM\",\n       \"Olivia McGuire\":\"OAM\",\n       \"Paul Thiel\":\"PBT\",\n       \"Patrick Morrisey\":\"PCM\",\n       \"Paycheck Protection Program\":\"PPP\",\n       \"Patrick W Collins\":\"PWC\",\n       \"QuickLine\":\"QL\",\n       \"Ryan Hoffman\":\"RJH\",\n       \"Rachael Schroder\":\"RS\",\n       \"Rob Slusser\":\"RS2\",\n       \"Shelly Carlson\":\"S_C\",\n       \"Scott A Norman\":\"SAN\",\n       \"Stephanie Schrage\":\"SAS\",\n       \"Sharyn Chesna\":\"SC\",\n       \"Steve Watts\":\"SCW\",\n       \"Sue English\":\"SE\",\n       \"Sharon Harrison\":\"SH\",\n       \"Sabrina L Kiser\":\"SLK\",\n       \"Sheila Sieradzki\":\"SRS\",\n       \"Stephanie Snoeberger\":\"SSS\",\n       \"Terri Mitchell\":\"TCM\",\n       \"Tom Neuffer\":\"TDN\",\n       \"Troy Kafka\":\"TEK\",\n       \"Tim Turner\":\"TJT\",\n       \"Tom Wilk\":\"TJW\",\n       \"Tammy L Johnson\":\"TLJ\",\n       \"Timothy L Nelson\":\"TLN\",\n       \"Terri Mitchell\":\"TM\",\n       \"Terry M Ploetz\":\"TMP\",\n       \"Timothy M Rudge\":\"TMR\",\n       \"Tim Spoelman\":\"TMS\",\n       \"Tom Konrad\":\"TRK\",\n       \"Tim Woloszyn\":\"TW1\",\n       \"Tim Warner\":\"TWW\",\n       \"Vicki Hoffman\":\"VH\",\n       \"William M Winterhaler\":\"WMW\",\n       \"Yolanda Estrada\":\"YE\",\n       \"Jessica A Schneider\":\"ZJS\",\n       \"Jerry Tomasic\":\"ZJT\",\n       \"Zoran Koricanac\":\"ZK\"\n    }\n}",
        "response_body_spec_config": "{}"
    },
    ...
    "ci-csi-documents_types": {
        ...
        "document_type_mapping": {
            ...
            "Bylaws": {
                ...
                "documentTypeName": "By Laws"
            },
            "UCC Search": {
                "applicationName": "Loan",
                "documentTypeName": "Lien/Judgement/UCC Search"
            },
            "Credit Memo": {
                "applicationName": "Customer",
                "documentTypeName": "Loan Approval"
            },
            "Fico Report": {
                "applicationName": "Customer",
            ...
            "Tax Archive": {
                "applicationName": "Loan",
                "documentTypeName": "Tax Information"
            },
            "US Passport": {
                "applicationName": "Customer",
                "documentTypeName": "Photo ID"
            },
            "Spreading Data": {
                "applicationName": "Customer",
                "documentTypeName": "Business Financial Spread"
            },
            "Stock Transfer": {
                "applicationName": "Loan",
                "documentTypeName": "Stock/Bond"
            },
            "Lease Agreement": {
                "applicationName": "Loan",
                "documentTypeName": "Leases"
            },
            "Board Resolution": {
                "applicationName": "Customer",
                "documentTypeName": "Authorization/Resolution"
            },
            "Commitment Letter": {
                "applicationName": "Loan",
                "documentTypeName": "Loan Commitment"
            },
            "Power Of Attorney": {
                "applicationName": "Customer",
            ...
            "Stock Certificates": {
                "applicationName": "Loan",
                "documentTypeName": "Stock Valuation"
            },
            "Tax Spreading Data": {
                "applicationName": "Loan",
            ...
            "UCC Filing Preview": {
                "applicationName": "Loan",
                "documentTypeName": "UCC Filing"
            },
            "Closing document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Closing Documents"
            },
            "Franchise Agreement": {
                "applicationName": "Customer",
                "documentTypeName": "Agency Franchise Agreements"
            },
            "Operating Agreement": {
                "applicationName": "Customer",
            ...
            "Corporate Resolution": {
                "applicationName": "Customer",
                "documentTypeName": "Authorization/Resolution of Corporate LLC Member"
            },
            ...
            "Deposit Decline Letter": {
                "applicationName": "Customer",
                "documentTypeName": "Deposit Account Documents"
            },
            "Preclosing document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Closing Documents"
            },
            ...
            "Complete Trust Document": {
                "applicationName": "Customer",
                "documentTypeName": "Legal Docs-trust"
            },
            "Customer Correspondence": {
                "applicationName": "Customer",
                "documentTypeName": "Correspondence"
            },
            "Loan Exception Document": {
                "applicationName": "Loan",
                "documentTypeName": "Exception Form"
            },
            "SAM.gov Search Document": {
                "applicationName": "Loan",
                "documentTypeName": "SAM-Excluded Parties Search"
            },
            "Sole Prop Certification": {
                "applicationName": "Customer",
                "documentTypeName": "Sole Ownership Authority"
            },
            "State Title Application": {
                "applicationName": "Loan",
                "documentTypeName": "Application for Certificate of Title"
            },
            "ETRAN Servicing Document": {
                "applicationName": "Loan",
                "documentTypeName": "SBA - Miscellaneous Documents"
            },
            "Etran Loan Auth Document": {
                "applicationName": "Loan",
                "documentTypeName": "SBA Authorization"
            },
            "Underwriting document(s)": {
                "applicationName": "Customer",
                "documentTypeName": "Underwriting Decision Report"
            },
            "Certificate of Trade Name": {
                "applicationName": "Customer",
                "documentTypeName": "Certificate"
            },
            "Counter Offer document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Notice to Borrower"
            },
            ...
            "Proof of Business Address": {
                "applicationName": "Loan",
                "documentTypeName": "Property Address"
            },
            ...
            "Closing signed document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Note & Mortgage Documents"
            },
            "Flood Determination Report": {
                "applicationName": "Loan",
                "documentTypeName": "Flood Search"
            },
            "Loan amortization schedule": {
                "applicationName": "Loan",
                "documentTypeName": "Amortization Schedule"
            },
            ...
            "Certificate of Organization": {
                "applicationName": "Customer",
                "documentTypeName": "Certificate of Inc/Org/LLP"
            },
            "Closing summary document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Note & Mortgage Documents"
            },
            "Fictitious Name Certificate": {
                "applicationName": "Customer",
                "documentTypeName": "Assumed Name Certificate"
            },
            ...
            "Signed 8821 Consent Document": {
                "applicationName": "Customer",
                "documentTypeName": "Tax Returns - Misc"
            },
            "KYC Risk Flag Report document": {
                "applicationName": "Loan",
                "documentTypeName": "Miscellaneous Documents"
            },
            "Application signed document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Application - Final"
            },
            "Franchise or Similar Agreement": {
                "applicationName": "Customer",
                "documentTypeName": "Agency Franchise Agreements"
            },
            "US Armed Forces or Military ID": {
                "applicationName": "Customer",
                "documentTypeName": "Photo ID"
            },
            "Unsigned 8821 Consent Document": {
                "applicationName": "Loan",
                "documentTypeName": "Tax Bill Authorization"
            },
            "Application summary document(s)": {
                "applicationName": "Loan",
            ...
            "Federal Tax Return (most recent)": {
                "applicationName": "Customer",
                "documentTypeName": "Business Tax Return"
            },
            "Post Boarding Document - Officer": {
                "applicationName": "Loan",
                "documentTypeName": "Miscellaneous Documents"
            },
            "Approval with conditions document": {
                "applicationName": "Loan",
                "documentTypeName": "Miscellaneous Documents"
            },
            ...
            "IRS Letter Regarding 501(c) status": {
                "applicationName": "Customer",
                "documentTypeName": "Entity Documents - Miscellaneous"
            },
            ...
            "Limited Liability Partnership Agreement": {
                "applicationName": "Customer",
                "documentTypeName": "Authorization/Resolution of LLC Partner"
            },
            "Pre Closing Document signed document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Closing Documents"
            },
            "Reg B Timer Exception Approval Document": {
                "applicationName": "Loan",
                "documentTypeName": "Miscellaneous Documents"
            },
            ...
            "Pre Closing Document summary document(s)": {
                "applicationName": "Loan",
                "documentTypeName": "Closing Documents"
            },
            ...
            "Articles of Incorporation (dated and certified)": {
                "applicationName": "Customer",
                "documentTypeName": "Articles of INC/ORG/LLP"
            },
